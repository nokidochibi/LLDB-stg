...
function openSongDetailModal(songName) {
    ...
    if (previousRecord) {
        ...
        messageHtml = `<div class="text-center"><span class="font-bold text-gray-800">${currentTourShort}</span>での演奏が<br><span class="font-bold text-aiko-red text-base ml-1">初披露</span>！🎉</div>`;
    }
